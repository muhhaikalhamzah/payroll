<x-app>
    ...
    <div class="page-header-card mb-4 p-4 rounded shadow-sm">
        ...
        <p class="text-white-50 mb-0">Fill in the form below to create a new overtime request.</p>
    </div>
            ...
            <form action="{{ route('overtime-requests.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="status" class="form-select" required>
                        ...
                        <option value="PENDING_MANAGER" {{ old('status') == 'PENDING_MANAGER' ? 'selected' : '' }}>Pending Manager</option>
